...
var ve = ["auto", "top", "bottom", "left", "right"].reduce((e, t) => e.concat([
  t,
  `${t}-start`,
  `${t}-end`
]), []);
  ...
  for (let i = d.length - 1; i >= 0; i--) {
    ...
    try {
      ...
      s.$_pendingHide = false, requestAnimationFrame(() => {
        if (s.$_pendingHide = false, !o[s.randomId] && he(s, r, e)) {
...
var ht = ["id", "aria-hidden", "tabindex", "data-popper-placement"];
var ut = {
  ref: "inner",
  class: "v-popper__inner"
};
var ft = createBaseVNode("div", { class: "v-popper__arrow-outer" }, null, -1);
var ct = createBaseVNode("div", { class: "v-popper__arrow-inner" }, null, -1);
var mt = [
  ft,
  ct
];
...
function Ce(e, t, o) {
  let i;
  const s = typeof t;
  return s === "string" ? i = { content: t } : t && s === "object" ? i = t : i = { content: false }, i.placement = Pt(i, o), i.targetNodes = () => [e], i.referenceNode = () => e, i;
}
var q;
var b;
var St = 0;
...
var Gt = Se;
function zt(e, t = {}) {
  e.$_vTooltipInstalled || (e.$_vTooltipInstalled = true, $e(u, t), e.directive("tooltip", ee), e.directive("close-popper", te), e.component("VTooltip", Pe), e.component("VDropdown", _e), e.component("VMenu", Te));
}
var qt = {
